...
[431639] = {
["event"] = "SPELL_CAST_START",
["source"] = "Shadow Vanguard Soldier",
["npcID"] = 212436,
},
[1236193] = {
["isChanneled"] = true,
...
["nameplateOtherBottomInset"] = "...dOns/WagoUI/libs/LibAddonProfiles/modules/Plater.lua:120",
...
["Desc"] = "",
["Hooks"] = {
["Initialization"] = "function(modTable)\n    \n    -- Last update by Luckyone: August 10, 2025\n    \n    local Retail = WOW_PROJECT_ID == WOW_PROJECT_MAINLINE\n    local Mists = WOW_PROJECT_ID == WOW_PROJECT_MISTS_CLASSIC\n    local IsRetailOrMists = Retail or Mists\n    \n    -- List of NPC ids\n    -- if you want to see their first name instead\n    modTable.firstName = {\n        -- Totems\n        [3527] = true, -- Healing Stream\n        [2630] = true, -- Earthbind\n        [61245] = true, -- Capacitor\n        [5925] = true, -- Grounding\n        [105451] = true, -- Counterstrike\n        [105427] = true, -- Skyfury\n        [97369] = true, -- Liquid Magma\n        -- Mists\n        [59915] = true, -- Jasper Guardian\n        [60051] = true, -- Cobalt Guardian\n        [60047] = true, -- Amethyst Guardian\n        -- Retail\n        [207796] = true, -- Burning Colossus\n        [214012] = true, -- Dark Colossus\n    }\n    \n    -- List of NPC ids\n    -- if you want to see their full name instead\n    modTable.fullName = {\n        -- [123456] = true,\n    }\n    \n    modTable.isMaxLevel = IsLevelAtEffectiveMaxLevel(UnitLevel('player'))\n    \n    local function Hex(r, g, b)\n        if type(r) == 'table' then\n            r, g, b = r.r or r[1], r.g or r[2], r.b or r[3]\n        end\n        \n        return (r and type(r) ~= 'string') and format('|cff%02x%02x%02x', r * 255, g * 255, b * 255) or '|cffFFFFFF'\n    end\n    \n    function level(unitId)\n        if modTable.isMaxLevel then return false end\n        \n        local level, color\n        \n        if IsRetailOrMists and (UnitIsWildBattlePet(unitId) or UnitIsBattlePetCompanion(unitId)) then\n            level = UnitBattlePetLevel(unitId)\n            local teamLevel = C_PetJournal.GetPetTeamAverageLevel()\n            color = (teamLevel ~= level) and GetRelativeDifficultyColor(teamLevel, level) or QuestDifficultyColors.difficult\n        else\n            level = UnitEffectiveLevel(unitId)\n            color = GetCreatureDifficultyColor(level)\n        end\n        \n        return format('%s%s|r - ', Hex(color), (level > 0) and level or '??')\n    end\n    \n    modTable.level = level\n    modTable.IsRetailOrMists = IsRetailOrMists\nend",
["Nameplate Updated"] = "function(self, unitId, unitFrame, envTable, modTable)\n    \n    local unitName = UnitName(unitId)\n    if not unitName then return end\n    \n    local npcId = unitFrame.namePlateNpcId\n    local displayName\n    \n    local namePrefix = modTable.level(unitId) or ''\n    \n    if modTable.firstName[npcId] then\n        displayName = namePrefix .. unitName:match('^(%S+)')\n    elseif modTable.fullName[npcId] then\n        displayName = namePrefix .. unitName\n    else\n        displayName = namePrefix .. unitName:match('(%S+)%s*$')\n    end\n    \n    unitFrame.healthBar.unitName:SetText(displayName)\nend",
},
["Prio"] = 1,
["Time"] = 1754855383,
["PlaterCore"] = 1,
...
["Hooks"] = {
["Initialization"] = "function(modTable)\n    \n    -- Last update by Luckyone: August 10, 2025\n    \n    local colors = {\n        priority = '#00fbff', -- Bright cyan 'Lightblue'\n        special = '#ff41fc', -- Vivid magenta 'Pink'\n    }\n    \n    modTable.NpcColors = {\n        -- Special coloring [SPECIAL]\n        [231176] = colors.special, -- Scaffolding [FLOOD]\n        [179733] = colors.special, -- Invigorating Fish Stick [GMBT]\n        [180433] = colors.special, -- Wandering Pulsar [GMBT]\n        [175576] = colors.special, -- Containment Cell [STRT]\n        [177237] = colors.special, -- Chains of Damnation [STRT]\n        [244302] = colors.special, -- Binding Javelin [EDA]\n        [240952] = colors.special, -- Evoked Spirit [EDA]\n        \n        -- Ara-Kara, City of Echoes [ARAK]\n        [216293] = colors.priority, -- Trilling Attendant\n        [218961] = colors.priority, -- Starved Crawler\n        [223253] = colors.priority, -- Bloodstained Webmage\n        [216340] = colors.priority, -- Sentry Stagshell\n        [216364] = colors.priority, -- Blood Overseer\n        \n        -- Eco-Dome Al'dani [EDA]\n        [234957] = colors.priority, -- Wastelander Ritualist\n        [234955] = colors.priority, -- Wastelander Pactspeaker\n        \n        -- Halls of Atonement [HOA]\n        [165414] = colors.priority, -- Depraved Obliterator\n        [164562] = colors.priority, -- Depraved Houndmaster\n        \n        -- Priory of the Sacred Flame [PSF]\n        [206697] = colors.priority, -- Devout Priest\n        [206698] = colors.priority, -- Fanatical Conjuror\n        [221760] = colors.priority, -- Risen Mage\n        \n        -- Operation: Floodgate [FLOOD]\n        [229686] = colors.priority, -- Venture Co. Surveyor\n        [229251] = colors.priority, -- Venture Co. Architect\n        [229212] = colors.priority, -- Darkfuse Demolitionist\n        [231312] = colors.priority, -- Venture Co. Electrician\n        \n        -- Tazavesh: So'leah's Gambit [GMBT]\n        [178142] = colors.priority, -- Murkbrine Fishmancer\n        [176551] = colors.priority, -- Vault Purifier\n        [179388] = colors.priority, -- Hourglass Tidesage\n        [180431] = colors.priority, -- Focused Ritualist\n        \n        -- Tazavesh: Streets of Wonder [STRT]\n        [177817] = colors.priority, -- Support Officer\n        [180336] = colors.priority, -- Cartel Wiseguy\n        [176395] = colors.priority, -- Overloaded Mailemental\n        [179841] = colors.priority, -- Veteran Sparkcaster\n        \n        -- The Dawnbreaker [DAWN]\n        [213892] = colors.priority, -- Nightfall Shadowmage\n        [214761] = colors.priority, -- Nightfall Ritualist\n        [213893] = colors.priority, -- Nightfall Darkcaster\n    }\n    \n    function modTable.UpdateColor(unitFrame, envTable)\n        if not unitFrame or not unitFrame.namePlateNpcId then return end\n        if unitFrame.IsNpcWithoutHealthbar or unitFrame.IsFriendlyPlayerWithoutHealthbar then return end\n        \n        local color = modTable.NpcColors[unitFrame.namePlateNpcId]\n        if color then\n            Plater.SetNameplateColor(unitFrame, color)\n        end\n    end\nend",
...
["url"] = "https://wago.io/LuckyoneUI-Plater/32",
...
["url"] = "https://wago.io/LuckyoneUI-Plater/33",
["blizzard_nameplate_font_override_enabled"] = true,
["health_cutoff_upper"] = false,
["cast_statusbar_spark_alpha"] = 1,
["aura2_y_offset"] = 5,
...
["Hooks"] = {
["Initialization"] = "function(modTable)\n    \n    -- Last update by Luckyone: August 10, 2025\n    \n    local Retail = WOW_PROJECT_ID == WOW_PROJECT_MAINLINE\n    local Mists = WOW_PROJECT_ID == WOW_PROJECT_MISTS_CLASSIC\n    local IsRetailOrMists = Retail or Mists\n    \n    -- List of NPC ids\n    -- if you want to see their first name instead\n    modTable.firstName = {\n        -- Totems\n        [3527] = true, -- Healing Stream\n        [2630] = true, -- Earthbind\n        [61245] = true, -- Capacitor\n        [5925] = true, -- Grounding\n        [105451] = true, -- Counterstrike\n        [105427] = true, -- Skyfury\n        [97369] = true, -- Liquid Magma\n        -- Mists\n        [59915] = true, -- Jasper Guardian\n        [60051] = true, -- Cobalt Guardian\n        [60047] = true, -- Amethyst Guardian\n        -- Retail\n        [207796] = true, -- Burning Colossus\n        [214012] = true, -- Dark Colossus\n    }\n    \n    -- List of NPC ids\n    -- if you want to see their full name instead\n    modTable.fullName = {\n        -- [123456] = true,\n    }\n    \n    modTable.isMaxLevel = IsLevelAtEffectiveMaxLevel(UnitLevel('player'))\n    \n    local function Hex(r, g, b)\n        if type(r) == 'table' then\n            r, g, b = r.r or r[1], r.g or r[2], r.b or r[3]\n        end\n        \n        return (r and type(r) ~= 'string') and format('|cff%02x%02x%02x', r * 255, g * 255, b * 255) or '|cffFFFFFF'\n    end\n    \n    function level(unitId)\n        if modTable.isMaxLevel then return false end\n        \n        local level, color\n        \n        if IsRetailOrMists and (UnitIsWildBattlePet(unitId) or UnitIsBattlePetCompanion(unitId)) then\n            level = UnitBattlePetLevel(unitId)\n            local teamLevel = C_PetJournal.GetPetTeamAverageLevel()\n            color = (teamLevel ~= level) and GetRelativeDifficultyColor(teamLevel, level) or QuestDifficultyColors.difficult\n        else\n            level = UnitEffectiveLevel(unitId)\n            color = GetCreatureDifficultyColor(level)\n        end\n        \n        return format('%s%s|r - ', Hex(color), (level > 0) and level or '??')\n    end\n    \n    modTable.level = level\n    modTable.IsRetailOrMists = IsRetailOrMists\nend",
["Nameplate Updated"] = "function(self, unitId, unitFrame, envTable, modTable)\n    \n    local unitName = UnitName(unitId)\n    if not unitName then return end\n    \n    local npcId = unitFrame.namePlateNpcId\n    local displayName\n    \n    -- Ensure namePrefix is never nil\n    local namePrefix = modTable.level(unitId) or ''\n    \n    if modTable.firstName[npcId] then\n        -- Extract first word, fallback to full name if pattern fails\n        local firstName = unitName:match('^(%S+)') or unitName\n        displayName = namePrefix .. firstName\n    elseif modTable.fullName[npcId] then\n        displayName = namePrefix .. unitName\n    else\n        -- Extract last word, fallback to full name if pattern fails\n        local lastName = unitName:match('(%S+)%s*$') or unitName\n        displayName = namePrefix .. lastName\n    end\n    \n    unitFrame.healthBar.unitName:SetText(displayName)\nend",
},
["Prio"] = 1,
["Name"] = "LuckyoneUI - Name",
["PlaterCore"] = 1,
...
["UID"] = "0x622bc8122a7529d",
["Hooks"] = {
["Initialization"] = "function(modTable)\n    \n    -- Last update by Luckyone: August 16, 2025\n    \n    local colors = {\n        priority = '#00fbff', -- Bright cyan 'Lightblue'\n        special = '#ff41fc', -- Vivid magenta 'Pink'\n    }\n    \n    modTable.NpcColors = {\n        -- Special coloring [SPECIAL]\n        [231176] = colors.special, -- Scaffolding [FLOOD]\n        [179733] = colors.special, -- Invigorating Fish Stick [GMBT]\n        [180433] = colors.special, -- Wandering Pulsar [GMBT]\n        [175576] = colors.special, -- Containment Cell [STRT]\n        [177237] = colors.special, -- Chains of Damnation [STRT]\n        [244302] = colors.special, -- Binding Javelin [EDA]\n        [240952] = colors.special, -- Evoked Spirit [EDA]\n        \n        -- Manaforge Omega [MF]\n        [241800] = colors.priority, -- Manaforged Titan [Nexus-King Salhadaar]\n        [242587] = colors.priority, -- Living Mass [Dimensius]\n        \n        -- Ara-Kara, City of Echoes [ARAK]\n        [216293] = colors.priority, -- Trilling Attendant\n        [218961] = colors.priority, -- Starved Crawler\n        [223253] = colors.priority, -- Bloodstained Webmage\n        [216340] = colors.priority, -- Sentry Stagshell\n        [216364] = colors.priority, -- Blood Overseer\n        \n        -- Eco-Dome Al'dani [EDA]\n        [234957] = colors.priority, -- Wastelander Ritualist\n        [234955] = colors.priority, -- Wastelander Pactspeaker\n        \n        -- Halls of Atonement [HOA]\n        [165414] = colors.priority, -- Depraved Obliterator\n        [164562] = colors.priority, -- Depraved Houndmaster\n        \n        -- Priory of the Sacred Flame [PSF]\n        [206697] = colors.priority, -- Devout Priest\n        [206698] = colors.priority, -- Fanatical Conjuror\n        [221760] = colors.priority, -- Risen Mage\n        \n        -- Operation: Floodgate [FLOOD]\n        [229686] = colors.priority, -- Venture Co. Surveyor\n        [229251] = colors.priority, -- Venture Co. Architect\n        [229212] = colors.priority, -- Darkfuse Demolitionist\n        [231312] = colors.priority, -- Venture Co. Electrician\n        \n        -- Tazavesh: So'leah's Gambit [GMBT]\n        [178142] = colors.priority, -- Murkbrine Fishmancer\n        [176551] = colors.priority, -- Vault Purifier\n        [179388] = colors.priority, -- Hourglass Tidesage\n        [180431] = colors.priority, -- Focused Ritualist\n        \n        -- Tazavesh: Streets of Wonder [STRT]\n        [177817] = colors.priority, -- Support Officer\n        [180336] = colors.priority, -- Cartel Wiseguy\n        [176395] = colors.priority, -- Overloaded Mailemental\n        [179841] = colors.priority, -- Veteran Sparkcaster\n        \n        -- The Dawnbreaker [DAWN]\n        [213892] = colors.priority, -- Nightfall Shadowmage\n        [214761] = colors.priority, -- Nightfall Ritualist\n        [213893] = colors.priority, -- Nightfall Darkcaster\n    }\n    \n    function modTable.UpdateColor(unitFrame, envTable)\n        if not unitFrame or not unitFrame.namePlateNpcId then return end\n        if unitFrame.IsNpcWithoutHealthbar or unitFrame.IsFriendlyPlayerWithoutHealthbar then return end\n        \n        local color = modTable.NpcColors[unitFrame.namePlateNpcId]\n        if color then\n            Plater.SetNameplateColor(unitFrame, color)\n        end\n    end\nend",
["Nameplate Updated"] = "function (self, unitId, unitFrame, envTable, modTable)\n    modTable.UpdateColor(unitFrame, envTable)\nend",
},
["Prio"] = 1,
["Time"] = 1755380015,
...
PlaterLogs = {
["_general_logs"] = {
"2025-09-03 20:08:50 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-03 20:01:18 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-02 17:53:07 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-02 07:59:28 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-02 07:37:35 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-02 07:33:50 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-02 07:26:09 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-02 07:23:15 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-01 21:53:30 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-01 21:50:56 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-01 21:45:14 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-01 20:41:09 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-09-01 20:10:11 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-08-31 22:13:13 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-08-31 10:38:28 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-08-30 20:01:57 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-08-29 20:49:57 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-08-29 09:01:16 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
"2025-08-29 01:20:55 | INIT | Plater-v614-Retail | Framework v617 | 11.2.0 | enUS | Shortwire",
},
["_error_logs"] = {
},
}
