...
L["SHOW_BEST_MAINS_SCORE"] = "Показывать М+ рейтинг главного персонажа из лучшего сезона"
L["SHOW_BEST_MAINS_SCORE_DESC"] = "Показывать лучший счет для М+ подземелий текущего сезона и рейдовый прогресс от основного персонажа. Игроки должны быть зарегистрированы на сайте Raider.IO и выбрать основного персонажа."
L["SHOW_BEST_RUN"] = "Показывать лучшее пройденное М+ подземелье в заголовке"
L["SHOW_BEST_RUN_DESC"] = "Показывать в заголовке подсказки лучшее пройденное М+ подземелье игрока в текущем сезоне."
L["SHOW_BEST_SEASON"] = "Показывать лучший М+ результат сезона в заголовке"
L["SHOW_BEST_SEASON_DESC"] = "В заголовке всплывающей подсказки отображается лучший результат игрока за сезон в М+ режиме. Если результат получен в предыдущем сезоне, то этот сезон будет отображаться как часть заголовка в подсказке."
